...
set :repo_url, "git@github.com:clousky2020/myblog.git"
set :user, 'ruby2'
...
# set :deploy_to, "/home/ruby/myblog"
...
set :yarn_flags, "--production --ignore-engines --ignore-optional --ignore-platform"
## Defaults:
# set :scm,           :git
# set :branch,        :master
# set :format,        :pretty
